...
idents=paste('Tumor',cancers,sep='__')



#Subset tumor cells

ATAC=subset(atac, test %in% idents)
...
all_wilcoxon_stat$cell_t2='Other_tumor'
...
write.table(final_wilcoxon_stat,"out/TF_score_difference.eachCancer_vs_Others_ATAC_based.tsv",quote=FALSE,sep="\t",row.names=FALSE)